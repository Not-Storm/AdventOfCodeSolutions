    ...
    class Program
    {
        ...
        static void First()
        {
            ...
            while (!success)
            {
                ...
                {
                    Console.WriteLine($"first number: {nums[index1]}");
                    Console.WriteLine($"second number: {nums[index2]}");
                    Console.WriteLine($"answer: {nums[index1] * nums[index2]}");
                    success = true;
                }
                else if (nums[index1] + nums[index2] != 2020)
                {
                    index2++;
